...
install_gnome() {
  ...
  install_packages linux-headers evince extension-manager epiphany gdm gnome-appfolders-manager gnome-bluetooth-3.0 gnome-desktop-common gnome-browser-connector gnome-subtitles gnac gmtk gnome-applets gnome-backgrounds gnome-calculator gnome-calendar gnome-characters gnome-clocks gnome-color-manager gnome-music gnome-connections gnome-firmware gnome-photos gnome-terminal-transparency gnome-contacts gnome-control-center gnome-disk-utility gnome-font-viewer gnome-gesture-improvements gnome-keyring gnome-logs gnome-maps gnome-menus gnome-network-displays gnome-nettool gnome-power-manager gnome-remote-desktop gnome-session gnome-settings-daemon gnome-shell gnome-multi-writer extension-manager gnome-system-monitor gnome-text-editor gnome-themes-extra gnome-tweaks gnome-user-share gnome-weather grilo-plugins gvfs gvfs-afc gvfs-dnssd gvfs-goa gvfs-google gvfs-gphoto2 gvfs-mtp gvfs-nfs gvfs-onedrive gvfs-smb gvfs-wsdd loupe nautilus rygel power-profiles-daemon simple-scan snapshot sushi tecla totem xdg-desktop-portal-gnome xdg-user-dirs-gtk jq libadwaita adwaita-fonts adwaita-cursors adwaita-icon-theme adwaita-icon-theme-legacy arandr xdg-terminal-exec-git pika-backup
  echo
