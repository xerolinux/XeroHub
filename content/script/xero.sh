  ...
  if [[ "$virt" != "none" ]]; then
    ...
    case "$virt" in
      oracle)
        ...
        ;;
      kvm)
        install_packages qemu-guest-agent spice-vdagent qemu-hw-display-qxl
        ;;
      microsoft)
        echo
...
install_gnome() {
  ...
  install_packages evince extension-manager epiphany gdm gnome-appfolders-manager gnome-bluetooth-3.0 gnome-desktop-common gnome-browser-connector gnome-subtitles gnac gmtk gnome-applets gnome-calendar gnome-characters gnome-clocks gnome-color-manager gnome-music gnome-connections gnome-firmware gnome-photos ptyxis gnome-contacts gnome-control-center gnome-font-viewer gnome-logs gnome-maps gnome-menus gnome-network-displays gnome-nettool gnome-power-manager gnome-remote-desktop gnome-session gnome-settings-daemon gnome-shell gnome-multi-writer gnome-system-monitor gnome-text-editor gnome-tweaks gnome-user-share gnome-weather grilo-plugins loupe nautilus rygel power-profiles-daemon simple-scan snapshot sushi tecla totem xdg-desktop-portal-gnome xdg-user-dirs-gtk jq libadwaita adwaita-fonts adwaita-cursors adwaita-icon-theme adwaita-icon-theme-legacy xdg-terminal-exec-git pika-backup qt5ct qt6ct kvantum fastfetch adw-gtk-theme tela-circle-icon-theme-purple kvantum-theme-libadwaita-git baobab cheese gnome-usage gnome-autoar tracker3-miners gitg d-spy geary gedit glade mousai sysprof ptyxis commit showtime shortwave evolution endeavour impression file-roller dconf-editor gnome-desktop gnome-builder gnome-podcasts gnome-dictionary gnome-sound-recorder gnome-online-accounts gnome-epub-thumbnailer nautilus-share nautilus-compare nautilus-admin-gtk4 nautilus-open-in-ptyxis nautilus-image-converter gnome-shell-extensions gnome-shell-extension-arc-menu gnome-shell-extension-caffeine gnome-shell-extension-gsconnect gnome-shell-extension-arch-update gnome-shell-extension-blur-my-shell gnome-shell-extension-appindicator gnome-shell-extension-dash-to-dock gnome-shell-extension-weather-oclock gnome-shell-extension-desktop-icons-ng waypipe qalculate-gtk libappindicator-gtk3 desktop-config-gnome pavucontrol lsb-release oh-my-posh-bin fastfetch
  echo
