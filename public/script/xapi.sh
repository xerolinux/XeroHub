...
add_chaotic_aur() {
    if ! grep -q "\[chaotic-aur\]" /etc/pacman.conf; then
        ...
        sudo pacman -U --noconfirm 'https://repos.xerolinux.xyz/chaotic-keyring.pkg.tar.zst'
        sudo pacman -U --noconfirm 'https://repos.xerolinux.xyz/chaotic-mirrorlist.pkg.tar.zst'
