...
hardwareIntro: "I do own many, 3 Desktops, 2 Laptops and a Mini PC. Main, NAS, Home-Lab & HTPC. Laptops are unimportant just runs my shop and testing various Distros."
hardware:
  - name: StationXero
  ...
  - name: XeroNAS
    ...
    image: images/Gwidybq.jpeg
    description: "My **NAS** PC, it stores all my personal data as well as my Linux ISOs & GOG game installers. It has `8GB RAM` with a `Ryzen 5 3600X` and an old `GT710` GPU. Running [OpenMediaVault](https://www.openmediavault.org) for managing all the storage. It ain't much but it works."
  - name: The HTPC
